...
//         </div>
        ...
        // <div className={`${cardDetails} flex p-8 flex-col max-w-xl border-4 border-neutral-600 rounded-xl bg-neutral-800`}>
        //     <div>{title}</div>
        //     <div>{desc}</div>
        //     <div>{tags}</div>
        //     <img
        //          className="h-45 w-50 object-cover border border-gray-200 dark:border-gray-800"
        //          src={image}
        //         alt={title}
        //          />
        ...
        <div
            className={`relative flex flex-col max-w-xl p-6 border-8 dark:border-neutral-600 border-zinc-400 rounded-2xl dark:bg-neutral-800 bg-zinc-200 shadow-lg hover:shadow-xl transition-shadow duration-300 ${className}`}
        ...
        >
            ...
            <div className="mt-4 p-3 ">
                ...
                {/* Description */}<span className="sm:text-md lg:text-lg font-semibold text-neutral-600 dark:text-neutral-400">{desc}</span></div>
                {/* Tags */} 
