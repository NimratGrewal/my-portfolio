...
const ProjectCard: React.FC<ProjectInputProps> = ({desc, website_link, has_source_code_link, project_link, is_deployed, title, has_demo, cardDetails, className, onClick, image, tags, demo_link}) => {
    ...
    return (
        ...
        className={`relative flex flex-col max-w-xl p-6 border-8 dark:border-neutral-600 border-zinc-400 rounded-2xl dark:bg-neutral-800 bg-zinc-200 shadow-lg hover:shadow-xl transition-shadow hover:bg-zinc-100 hover:dark:bg-neutral-900 duration-300 ${className}`}
      >
