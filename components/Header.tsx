...
<nav className="z-30 fixed top-0 p-4 w-full bg-opacity-75 dark:bg-opacity-95 backdrop-blur-md flex justify-between items-center bg-white dark:bg-neutral-900 shadow-md">
      {/* Left Side: Name */}
      ...
      <div className="flex gap-4 items-center">
        ...
        <a
          ...
          className="text-gray-700 dark:text-gray-300 hover:text-neutral-600 dark:hover:text-neutral-400 transition duration-300"
        >
          <svg
            className="w-6 h-6"
            fill="currentColor"
